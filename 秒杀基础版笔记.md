...
34. navicat插入一条数据 重启App 显示用户数据
    ...
    <img src="/Users/yangwu/Library/Application Support/typora-user-images/image-20210413094730784.png" alt="image-20210413094730784" style="zoom:25%;" />
...
26. 总结：SpringMVC三层从上到下 controller service dao   dataobject负责数据库数据到service层的传输 service服务层组装model核心领域模型 controller层控制返回给前端展示的**VO对象**保证UI只使用**对象需要展示的字段**
27. 
